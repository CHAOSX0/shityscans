...
export default function DMCA(){
  ...
  <div className="mainholder rtl">
   <Nav Items={[{text: 'الرئيسية', URL:'/'}, {text: 'أعمالنا', URL: '/serieslist'}, {text:'المفضلة', URL: '/favorite'}]}/>
    <div id="content">
      <div className="blox mlb kln">
        <ins
          className="adsbygoogle"
          style={{ display: "block" }}
          data-ad-format="autorelaxed"
          data-ad-client="ca-pub-2891080985035766"
          data-ad-slot={3802699005}
        />
      </div>
      <br />
      <div className="wrapper">
        <div className="postbody">
          <div className="bixbox">
            ...
            <div className="col-single-blog ck-content">
  <h2>
    <strong>Privacy Policy</strong>
  </h2>
  <p>
    At Scanly, accessible from https://scanly.org, one of our main priorities
    is the privacy of our visitors. This Privacy Policy document contains types
    of information that is collected and recorded by Scanly and how we use it.
  </p>
  <p>
  ...
  <p>
    ...
    and/or collect in Scanly.org. This policy is not applicable to any information
  ...
  <h2>Log Files</h2>
  <p>
    scanly follows a standard procedure of using log files. These files log
  ...
  <p>
    Like any other website, scanly uses ‘cookies’. These cookies are used to
  ...
  <p>
    ...
    advertising partners of scanly.
  </p>
  <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on scany, which are sent directly to users’ browser.
  ...
  <p>
    Note that scanly has no access to or control over these cookies that are
    used by third-party advertisers.
  </p>
  <h2>Third Party Privacy Policies</h2>
  <p>
    scanly’s Privacy Policy does not apply to other advertisers or websites.
  ...
  <p>
    scanly.org does not knowingly collect any Personal Identifiable Information
  ...
  <p>
    <br />
    Fist of all, We thank you very much for your support, only with you we can
    keep our work going.
  </p>
  <p>
    scanly uses the valuable points you donate to pay our translators and produce
    new chapters, and this is why
  </p>
  <p>
    We can happylly refund the unused points, but the points you use to buy
    chapters are unrefundable.
  </p>
</div>
